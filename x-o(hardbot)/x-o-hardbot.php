...
<head>
    ...
    <title>Крестики-нолики с непобедимым ботом</title>
    <link rel="stylesheet" href="../css/loader.css">
    <link rel="stylesheet" href="./css/x-o-hardbot.css">
...
<body>
    ...
    <div class="container">
        <header>
            <h1>Крестики-нолики с непобедимым ботом</h1>
        </header>
        <div id="gameBoard">
    ...
    <script src="x-o-hardbot.js"></script>
</body>
</html>